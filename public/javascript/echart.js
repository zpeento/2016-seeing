...
var option = {
    ...
    series : [ {
            ...
            nodes : [
                ...
                {id:9,category:2,name:'comment',label:'影片评价',ignore:true,flag:true,card:'comment',initial:[690,505],fixX:true,fixY:true},
                {id:10,category:1,name:'company',label:'发行公司',ignore:true,flag:true,initial:[370,140],fixX:true,fixY:true},
                {id:11,category:1,name:'director',label:'导演',ignore:true,flag:true,initial:[300,180],fixX:true,fixY:true},
                {id:12,category:1,name:'scriptwriter',label:'编剧',ignore:true,flag:true,initial:[260,220],fixX:true,fixY:true},
