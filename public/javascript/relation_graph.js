...
var option = {
    ...
    series : [ {
        ...
        nodes : [
            ...
            {id:16,category:1,name:'3',label:'克里斯多夫·布鲁多',ignore:true,flag:true,card:'role'},
            {id:17,category:2,name:'4',label:'朗·霍华德',ignore:true,flag:true,card:'director'},
            {id:18,category:2,name:'5',label:'大卫·凯普',ignore:true,flag:true,card:'scriptwriter'},
            {id:19,category:2,name:'6',label:'汤姆·汉克斯',ignore:true,flag:true,card:'actor'},
            {id:20,category:2,name:'7',label:'菲丽希缇·琼斯',ignore:true,flag:true,card:'actor'},
            {id:21,category:2,name:'8',label:'伊尔凡·可汗',ignore:true,flag:true,card:'actor'},
            {id:22,category:2,name:'9',label:'奥马·希',ignore:true,flag:true,card:'actor'},
